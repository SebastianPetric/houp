    ...
    let tempNew = newGroup.groupRequestIDs!.sorted()
        ...
        for user in tempNew {
            if(!(tempOld.contains(user))) {
                print("1) Neue Anfrage! Jemand will der Gruppe \(oldGroup.nameOfGroup!) beitreten!")
            }
        }
    }
