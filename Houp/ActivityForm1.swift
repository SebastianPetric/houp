...
class ActivityForm1: UIViewController{
    ...
    let question = CustomViews.shared.getCustomLabel(text: "Wie sehr war dein Verlangen nach Alkohol?", fontSize: 15, numberOfLines: 2, isBold: true, textAlignment: .center, textColor: .black)
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.333333, statusText: "1 von 3", progressColor: UIColor().getSecondColor())
