...
class ActivityWeekForm3: UIViewController, UITextFieldDelegate{
    ...
    let activityText = CustomViews.shared.getCustomTextField(placeholder: "z.B. Tanzen lernen", keyboardType: .default, isPasswordField: false, textColor: .black, backgroundColor: UIColor().getFourthColor())
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.4285714286, statusText: "3 von 7", progressColor: UIColor().getFourthColor())
