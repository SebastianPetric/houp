...
class ActivityWeekForm5: UIViewController, UITextFieldDelegate{
    ...
    let activityText = CustomViews.shared.getCustomTextField(placeholder: "z.B. tanzen gehen", keyboardType: .default, isPasswordField: false, backgroundColor: UIColor().getSecondColor())
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.7142857143, statusText: "5 von 7", progressColor: UIColor().getSecondColor())
