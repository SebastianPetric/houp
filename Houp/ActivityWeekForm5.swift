...
class ActivityWeekForm5: UIViewController, UITextFieldDelegate{
    ...
    let activityText = CustomViews.shared.getCustomTextField(placeholder: "z.B. eine Fremdsprache lernen", keyboardType: .default, isPasswordField: false, textColor: .black, backgroundColor: UIColor().getFourthColor())
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.7142857143, statusText: "5 von 7", progressColor: UIColor().getFourthColor())
