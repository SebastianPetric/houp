...
class ActivityWeekForm6: UIViewController, UITextFieldDelegate{
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.8571428571, statusText: "6 von 7", progressColor: UIColor().getSecondColor())
    ...
    func continueWeek(){
        if(self.continueButton.layer.borderColor == UIColor().getSecondColor().cgColor){
            ...
            let controller = ActivityWeekForm7()
