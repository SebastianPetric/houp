...
class ActivityWeekForm4: UIViewController, UITextFieldDelegate{
    ...
    let activityText = CustomViews.shared.getCustomTextField(placeholder: "z.B. Spazieren gehen", keyboardType: .default, isPasswordField: false, textColor: .black, backgroundColor: UIColor().getFourthColor())
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.5714285714, statusText: "4 von 7", progressColor: UIColor().getFourthColor())
