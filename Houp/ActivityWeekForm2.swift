...
class ActivityWeekForm2: UIViewController, UITextFieldDelegate{
    ...
    let activityText = CustomViews.shared.getCustomTextField(placeholder: "z.B. ein Buch lesen", keyboardType: .default, isPasswordField: false, textColor: .black, backgroundColor: UIColor().getFourthColor())
    ...
    let progressbar = CustomViews.shared.getCustomProgressionView(status: 0.2857142857, statusText: "2 von 7", progressColor: UIColor().getFourthColor())
